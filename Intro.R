...
# Data frame containing first two columns
metadata[ , 1:2]
# Data frame containing first, third and sixth rows 
metadata[c(1,3,6),]
# Extract the celltype column for the first three samples 
metadata[c('sample1','sample2','sample3'),'celltype']
# To remind yourself of the column or row names:
## Check column names or row names of the metadata data frame 
colnames(metadata)
rownames(metadata)
...
which_idx <- which(metadata$celltype == 'typeA')
metadata[which_idx,]
